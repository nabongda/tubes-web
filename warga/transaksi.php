        ...
        <div class="row mb-2">
          <div class="col-sm-12">
            <ol class="breadcrumb float-sm-left">
              ...
              <li class="breadcrumb-item active">Pesan Makam</li>
            </ol>
          </div><!-- /.col -->
        </div><!-- /.row -->
      </div><!-- /.container-fluid -->
          ...
          <div class="col-md-12">
            ...
            <div class="card">
              <div class="card-header bg-success">
                <h3 class="card-title">Pesan Makam</h3>
              </div>
              <!-- /.card-header -->
              <!-- form start -->
              <form role="form" id="quickForm" method="post" action="checkout.php">
                <div class="card-body">
                  ...
                  <div class="form-group">
                    ...
                    <input type="text" name="namaj" class="form-control" id="namaJenazah" placeholder="Masukkan nama jenazah" required>
                  </div>
                  <div class="form-group">
                    <label for="petak">Petak</label>
                    <input type="text" name="petak" class="form-control" value="<?php echo $_GET['petak'];?>"id="petak" readonly>
                  </div>
                  <div class="form-group">
