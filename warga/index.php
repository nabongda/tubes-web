      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item has-treeview menu-open">
            <a href="index.php" class="nav-link active" style="background-color: #3CB371">
              <i class="nav-icon fas fa-tachometer-alt"></i>
              <p style="color: white !important">Dashboard</p>
            </a>
          </li>
          <li class="nav-item has-treeview">
            <a href="dpemesanan.php" class="nav-link">
        ...
        <div class="row">
          <div class="col-lg-3 col-6">
            ...
            <div class="small-box bg-danger">
              ...
              <a href="dpemesanan.php" class="small-box-footer">More info <i class="fas fa-arrow-circle-right"></i></a>
            </div>
          </div>
          <div class="col-lg-3 col-6">
            <!-- small box -->
          ...
          <div class="col-md-12">
            ...
            <div class="card">
              <div class="card-header bg-success">
                <h3 class="card-title">Hallo, <?php echo $_SESSION['nama_user']; ?>! </h3>
              </div>
              <!-- /.card-header -->
              <!-- form start -->
              <form role="form" id="quickForm">
                <div class="card-body">
                  <div class="form-group">
                    <label>Selamat Datang di Sistem Booking Pemakaman</label>
                  </div>
                </div>
              </form>
            </div>
