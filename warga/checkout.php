        ...
        <div class="row mb-2">
          <div class="col-sm-12">
            <ol class="breadcrumb float-sm-left">
              ...
              <li class="breadcrumb-item"><a href="dpemesanan.php">Pilih Makam</a></li>
              <li class="breadcrumb-item"><a href="transaksi.php">Pesan Makam</a></li>
        ...
        <div class="row">
          ...
          <div class="col-md-12">
            ...
            <div class="card">
              ...
              <!-- /.card-header -->
              <!-- form start -->
              <form role="form" id="quickForm" method="post" action="checkout.php">
                <div class="card-body">
                  <div class="form-group">
                    <label for="tgltrans">Tanggal Transaksi</label>
                    <input type="text" name="tgltrans" class="form-control" id="tgltrans" value="<?php echo $_SESSION['tgl_trans']; ?>" readonly>
                  </div>
                  <div class="form-group">
                  ...
                  <div class="form-group">
                    ...
                    <input type="text" name="harga" class="form-control" onkeypress="return hanyaAngka(event)" value="<?php echo $_GET['harga'];?>" id="harga" readonly>
                  </div>
                  <div class="form-group">
                    <label for="uploadbt">Upload Bukti Transfer</label>
                    <input type="file" name="uploadbt" class="form-control-file" id="uploadbt" required>
                  </div>
                </div>
                <!-- /.card-body -->
